...
public class QualityControlActivity extends BaseActivity {
    ...
    private LinearLayout linerBarQuality;
...
//        linerBarQuality = findViewById(R.id.linerbarquality);
//        setBarColor();
//        setLightStatusBarColor(this);
//        setBarLayout(linerBarQuality);
    ...
    public void setClickListener() {
        ...
        qcSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SingleBaseConfig.getBaseConfig().setGesture(Float.valueOf(qcGestureEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setIllumination(Integer.valueOf
                        (qcIlluminiationEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setBlur(Float.valueOf(qcBlurEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setLeftEye(Float.valueOf(qcEyeEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setRightEye(Float.valueOf(qcEyeEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setLeftCheek(Float.valueOf(qcCheekEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setRightCheek(Float.valueOf(qcCheekEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setNose(Float.valueOf(qcNoseEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setMouth(Float.valueOf(qcMouseEtThreshold.getText().toString()));
                SingleBaseConfig.getBaseConfig().setChinContour(Float.valueOf(qcChinEtThreshold.getText().toString()));
        ...
        cwGesture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerGesture, tvGesture, QualityControlActivity.this,
        ...
        cwIlluminiation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerIlluminiation, tvIlluminiation, QualityControlActivity.this,
        ...
        cwBlur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerBlur, tvBlur, QualityControlActivity.this,
        ...
        cwocclusion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PWTextUtils.showDescribeText(linerocclusion, tvocclusion, QualityControlActivity.this,
