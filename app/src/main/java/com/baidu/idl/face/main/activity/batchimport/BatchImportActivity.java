package com.baidu.idl.face.main.activity.batchimport;
...
import com.baidu.idl.face.main.view.CircularProgressView;
...
public class BatchImportActivity extends BaseActivity implements View.OnClickListener, OnImportListener,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.image_import_back:
                finish();
                break;

            case R.id.button_prog_close:
                animatorTranslateDown(mRelativeImport);
                break;

            case R.id.image_delete:    // 删除导入的库
                mTipDialog.show();
