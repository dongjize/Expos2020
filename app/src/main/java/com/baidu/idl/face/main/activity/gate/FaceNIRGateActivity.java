...
public class FaceNIRGateActivity extends BaseActivity implements View.OnClickListener {
...
//                    mUser = null;
                    ...
                    if (user.equals(mUser)) {
                        if (System.currentTimeMillis() - mUserTime > 3 * 1000) {
                            try {
...
//                                Handler handler = new Handler();
                    ...
                    if (!user.equals(mUser)) {
                        mUserTime = System.currentTimeMillis();
                        Log.e(TAG, user.getUserId() + " " + user.getFaceToken());
                        if (mUser != null) {
                            Log.e(TAG, mUser.getUserId() + " " + mUser.getFaceToken());
                        }
