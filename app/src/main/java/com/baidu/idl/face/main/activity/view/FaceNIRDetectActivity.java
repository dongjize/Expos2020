...
import com.baidu.idl.face.main.view.FaceRoundProView;
 ...
 */
public class FaceNIRDetectActivity extends BaseActivity implements View.OnClickListener {
    private static final String TAG = FaceNIRDetectActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_register_nir);
        initView();
    ...
    private void initView() {
        ...
        mCircleHead.setBorderWidth(DensityUtils.dip2px(FaceNIRDetectActivity.this,
                3));
...
//            mFaceRoundProView.setTipText("");
            ...
            bundle.putString("bitmap", BitmapUtils.bitmapToBase64(mCropBitmap, 100));
            bundle.putByteArray("features", mFeatures);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.image_register_back:    // 返回
                finish();
                break;

            case R.id.btn_collect_confirm:   // 用户名注册
...
//                }
            ...
            case R.id.btn_continue_reg:      // 继续注册
            ...
            case R.id.btn_return_home:       // 回到首页
                // 关闭摄像头
                CameraPreviewManager.getInstance().stopPreview();
                finish();
                break;

            case R.id.image_input_delete:   // 清除输入
                mEditName.setText("");
                mTextError.setVisibility(View.INVISIBLE);
                break;
