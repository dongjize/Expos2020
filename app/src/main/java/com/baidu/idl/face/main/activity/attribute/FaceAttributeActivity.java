package com.baidu.idl.face.main.activity.attribute;
 ...
 * description :
 */
public class FaceAttributeActivity extends BaseActivity {
    ...
    public void init() {
        ...
        btnSetting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(FaceAttributeActivity.this, SettingMainActivity.class);
