...
public class FaceAuth {
    ...
    public void setOnline(boolean online) {
        // AndroidLicenser.setOnline(online);
    }

    public void setActiveLog(BDFaceSDKCommon.BDFaceLogInfo logInfo, int isLog) {
        nativeSetActiveLog(logInfo.ordinal(), isLog);
    }
    ...
    private native void nativeSetActiveLog(int logInfo, int isLog);
